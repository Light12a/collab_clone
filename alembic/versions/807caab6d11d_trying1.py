...
def upgrade():
    ...
    sa.Column('expired_date', mysql.BIGINT(display_width=11), nullable=True, comment='Expired Time : Expired time of token'),
    sa.Column('create_date', mysql.DATE(display_width=11), nullable=True, comment='Create Date : Created Date of token'),
